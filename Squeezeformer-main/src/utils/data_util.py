...
def create_inputs_from_mic(
    ...
    return data
#Outputs: {
#     "inputs": <tf.Tensor: shape=(2, 3), dtype=float32, numpy=...>,
#     "inputs_length": <tf.Tensor: shape=(2,), dtype=int32, numpy=...>,
#     "predictions": <tf.Tensor: shape=(2,), dtype=int32, numpy=...>,
#     "predictions_length": <tf.Tensor: shape=(2,), dtype=int32, numpy=...>
# }
...
# {
#     "logits": <tf.Tensor: shape=(2, 3), dtype=float32, numpy=...>,
#     "logits_length": <tf.Tensor: shape=(2,), dtype=int32, numpy=...>
# }
