...
#Tính số batch cần thiết để chia một tập dữ liệu có nsamples mẫu thành các batch.
'''
drop_remainders = True, bỏ batch cuối cùng nếu không có đủ batch_size., làm tròn xuống.
outputs: int

examples: get_num_batches(1050, 128, drop_remainders=True)
= floor(1050 / 128) = floor(8.2) = 8
'''
...
# Gộp 2 chiều cuối cùng thành 1 chiều duy nhất
