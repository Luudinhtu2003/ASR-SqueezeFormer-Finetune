...
import logging  #Thư viện ghi log (ghi chú)
from typing import Union, List
import warnings #Thư viện xử lý các cảnh báo runtime
import tensorflow as tf

#tắt các cảnh báo không cần thiết, giao diện log sạch hơn
#Thiết lập mức độ log của Tensorflow, chỉ in mức mong muốn

logger = tf.get_logger()

def setup_environment():
    warnings.simplefilter("ignore")  #Ko in cảnh báo
    logger.setLevel(logging.INFO)   #Chỉ in thông báo cao hơn INFO
    return logger
