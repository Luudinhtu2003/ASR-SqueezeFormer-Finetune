"""
Trích xuất những file đã bị thay đổi hoặc bị xóa từ hai file TSV khác nhau.
"""
...
original, original_lines = read_tsv('train_vivos.tsv')
modified, _ = read_tsv('Ftrain_vivos.tsv')
