...
# Lưu ra các file TSV
train_df.to_csv('fpt_65_train.tsv', sep='\t', index=False)
test_df.to_csv('fpt_65_test.tsv', sep='\t', index=False)
valid_df.to_csv('fpt_65_valid.tsv', sep='\t', index=False)
